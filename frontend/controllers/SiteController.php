...
class SiteController extends Controller
{
    ...
    {
        $company = Article::find()->where(['is_published' => '1', 'id' => '10'])->one();
        $products = Product::find()->where(['is_published' => '1'])->orderBy('created DESC')->limit(4)->all();
        $advantages = Advantage::find()->where(['is_published' => '1'])->orderBy('created ASC')->all();
        $banners = Banner::find()->where(['is_published' => '1'])->orderBy('sort_index ASC')->all();
        $partner = Article::find()->where(['is_published' => '1', 'id' => '11'])->one();
        $newsList = News::find()->where(['is_published' => '1'])->orderBy('created DESC')->all();
        $questions = Question::find()->where(['is_published' => '1'])->orderBy('created DESC')->all();
